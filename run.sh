...
# constrastive
# python tests/main.py --run_group Debug_baseline --exp_name contrastive-freeze-exp_bs-plc_her_reward-sample_delay \
...
# # # soft_update
python tests/main.py --run_group Debug_baseline --exp_name soft_update_1 \
    --env ant_maze --max_path_length 300 \
    --seed 0 --traj_batch_size 8 --n_parallel 4 \
    --normalizer_type off \
    --sac_max_buffer_size 100000 \
