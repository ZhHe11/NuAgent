...
python tests/main.py --run_group kitchen_debug  --env kitchen --max_path_length 50 --seed 0 --n_parallel 4 --normalizer_type off --num_video_repeats 1 --frame_stack 3 --sac_max_buffer_size 100000 --sac_lr_a -1 --n_epochs_per_log 25 --n_epochs_per_eval 100 --n_epochs_per_save 100 --n_epochs_per_pt_save 100 --encoder 1 --sample_cpu 0 \
    --algo SZPC --exp_name d1-SZN --phi_type Projection --explore_type SZN --policy_type baseline --sample_type baseline --num_her 0 --trans_optimization_epochs 100 --target_theta 1 --is_wandb 1 --trans_minibatch_size 1024 --common_lr 1e-4 --SZN_w2 10 --SZN_w3 0 --SZN_window_size 5 --SZN_repeat_time 1 --Repr_temperature 0.5 --Repr_max_step 100 --save_pt_step 500 --z_unit 0 --discrete 0 --traj_batch_size 8 --dim_option 4  --wandb_note 'discrete=0; SZN' 
