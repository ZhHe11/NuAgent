...
python tests/main.py --run_group Quadruped --env dmc_quadruped --max_path_length 200 --seed 0 --traj_batch_size 8 --n_parallel 4 --normalizer_type off --video_skip_frames 2 --frame_stack 3 --sac_max_buffer_size 300000 --eval_plot_axis -15 15 -15 15 --n_epochs_per_log 25 --n_epochs_per_eval 125 --n_epochs_per_save 1000 --n_epochs_per_pt_save 1000 --discrete 0 --dim_option 4 --encoder 1 --sample_cpu 0 \
    --algo PSZP --exp_name SZN-t05-no_g_dir --phi_type Projection --explore_type SZN --policy_type baseline --sample_type baseline --num_her 0 --trans_optimization_epochs 200 --target_theta 1 --is_wandb 1 --trans_minibatch_size 256 --common_lr 1e-3 --model_master_num_layers 2 --wandb_note 'unchange params'



    --algo SZN --exp_name SZN-TrainBatch_256_50-path50 --phi_type baseline --policy_type baseline --explore_type SZN --sample_type baseline --num_her 0 --trans_optimization_epochs 50 --target_theta 1 --is_wandb 1 --trans_minibatch_size 256 
    ...
    --algo SZN_batch --exp_name SZN_batch-w50-path50 --phi_type baseline --policy_type baseline --explore_type SZN --sample_type baseline --num_her 0 --trans_optimization_epochs 50 --target_theta 1 --is_wandb 1 --trans_minibatch_size 256 
...
# # SZN
#     --exp_name baseline --phi_type baseline --policy_type baseline --explore_type baseline --sample_type baseline --num_her 0 --_trans_phi_optimization_epochs 200 --_trans_policy_optimization_epochs 1 --target_theta 1 --is_wandb 1 --trans_minibatch_size 256 
