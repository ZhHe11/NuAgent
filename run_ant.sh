...
# SZN
python tests/main.py --run_group Ant --env ant --max_path_length 200 --seed 0 --traj_batch_size 8 --n_parallel 1 --normalizer_type preset --eval_plot_axis -50 50 -50 50 --n_epochs_per_log 10 --n_epochs_per_eval 20 --n_epochs_per_save 500 --sac_max_buffer_size 1000000 --discrete 0 --dim_option 2 \
