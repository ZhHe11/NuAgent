...
python tests/main.py --run_group MazeSZN --env ant_maze --max_path_length 300 --seed 0 --traj_batch_size 16 --n_parallel 2 --normalizer_type off --sac_max_buffer_size 30000000  --n_epochs_per_log 25 --n_epochs_per_eval 50 --n_epochs_per_save 100 --n_epochs_per_pt_save 100 --discrete 0 --dim_option 2 --sac_scale_reward 1 \
    --algo PSZP --exp_name PSZP-6-PopDeque_windowsize10-softmax1-w101w25 --phi_type Projection --explore_type SZN --policy_type baseline --sample_type baseline --num_her 0 --trans_optimization_epochs 75 --target_theta 1 --is_wandb 0 --trans_minibatch_size 1024 --common_lr 1e-3 --model_master_num_layers 2
