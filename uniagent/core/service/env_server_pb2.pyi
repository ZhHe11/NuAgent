...
class VecEnvDesc(_message.Message):
    ...
    def __init__(self, env_id: _Optional[str] = ..., env_num: _Optional[int] = ..., max_episode_steps: _Optional[int] = ...) -> None: ...
...
class EnvRequest(_message.Message):
    __slots__ = ("instance_ids", "b_actions", "vec_env_desc")
    ...
    def __init__(self, instance_ids: _Optional[_Iterable[str]] = ..., b_actions: _Optional[bytes] = ..., vec_env_desc: _Optional[_Union[VecEnvDesc, _Mapping]] = ...) -> None: ...

class EnvReply(_message.Message):
    __slots__ = ("b_states", "b_observations", "instance_ids", "all_done")
    ...
    instance_ids: _containers.RepeatedScalarFieldContainer[str]
    all_done: bool
    def __init__(self, b_states: _Optional[bytes] = ..., b_observations: _Optional[bytes] = ..., instance_ids: _Optional[_Iterable[str]] = ..., all_done: bool = ...) -> None: ...
